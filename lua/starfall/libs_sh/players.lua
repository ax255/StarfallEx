...
-- Unlike Entity:getEyeAngles, this function does not include angles of the Player's Entity:getParent.
-- @shared
-- @return Angle 
function player_methods:getLocalEyeAngles()
	return awrap(Ply_LocalEyeAngles(getply(self)))
end
